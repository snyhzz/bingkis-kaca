...
<?php $__env->startSection('title', 'PhotoBooth'); ?>
            ...
            <div class="review-left">
                <div class="review-left-content">
                    <div class="character-container">
                        <img src="<?php echo e(asset('images/character-left.png')); ?>" alt="Character" class="character-image" onerror="this.style.display='none'">
                    </div>
            ...
            <div class="review-right">
                <div class="review-right-content">
                    ...
                    <div class="frame-picker">
                        ...
                        <?php if(isset($framesByCount) && $framesByCount->isNotEmpty()): ?>
                            
                            <div id="dynamicFrameSelector">
                                <?php $__currentLoopData = $framesByCount; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $photoCount => $frames): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="frame-group" 
                                     data-photo-count="<?php echo e($photoCount); ?>" 
                                     style="<?php echo e($photoCount != 4 ? 'display: none;' : ''); ?>">
                                    ...
                                    <div class="frames-grid">
                                        ...
                                        <div class="frame-option <?php echo e($loop->first && $photoCount == 4 ? 'active' : ''); ?>" 
                                             data-frame-id="<?php echo e($frame->id); ?>"
                                             data-frame-path="<?php echo e($frameDataPath ?? asset('images/placeholder-frame.png')); ?>"
                                             data-color="<?php echo e($frame->color_code); ?>"
                                             data-photo-count="<?php echo e($frame->photo_count); ?>"
                                             title="<?php echo e($frame->name); ?>">
                                            
                                            <div class="frame-preview-thumb">
                                                <?php if($frameUrl): ?>
                                                    <img src="<?php echo e($frameUrl); ?>" 
                                                         alt="<?php echo e($frame->name); ?>"
                                                         loading="lazy"
                                                         onerror="console.error('Frame load failed:', '<?php echo e($frame->name); ?>', this.src); this.parentElement.innerHTML='<div class=\'frame-placeholder-thumb\' style=\'display:flex;flex-direction:column;align-items:center;justify-content:center;gap:0.5rem;\'><span style=\'font-size:2rem;\'>❌</span><small style=\'font-size:0.7rem;color:#999;\'><?php echo e($frame->name); ?></small><small style=\'font-size:0.6rem;color:#dc3545;\'><?php echo e($frameBasename); ?></small></div>'">
                                                <?php else: ?>
                                                    <div class="frame-placeholder-thumb" style="display:flex;flex-direction:column;align-items:center;justify-content:center;gap:0.5rem;">
                                                        ...
                                                        <small style="font-size:0.7rem;color:#999;"><?php echo e($frame->name); ?></small>
                                                        <small style="font-size:0.6rem;color:#dc3545;"><?php echo e($frameBasename); ?></small>
                                                    </div>
                                                <?php endif; ?>
                                            </div>
                                            
                                            <div class="frame-info">
                                                <span class="frame-name"><?php echo e(Str::limit($frame->name, 15)); ?></span>
                                                <span class="frame-color-badge" 
                                                      style="background: <?php echo e($frame->color_code == 'brown' ? '#6B4423' : ($frame->color_code == 'cream' ? '#CBA991' : '#fff')); ?>; 
                                                             color: <?php echo e($frame->color_code == 'white' ? '#000' : '#fff'); ?>; 
                                                             border: <?php echo e($frame->color_code == 'white' ? '1px solid #ddd' : 'none'); ?>;">
                                                    <?php echo e(ucfirst($frame->color_code)); ?>
                    ...
                    <div class="review-actions">
                        ...
                        <?php else: ?>
                        <a href="<?php echo e(route('login')); ?>" class="btn-review btn-login">
                    ...
                    <div class="character-right-container">
                        <img src="<?php echo e(asset('images/character-right.png')); ?>" alt="Character" class="character-image-right" onerror="this.style.display='none'">
                    </div>
                </div>
            </div>
        </div>
...
<div id="loginModal" class="login-prompt-modal" style="display: none;">
    <div class="login-prompt-content">
        ...
        <div class="login-actions">
            ...
            <a href="<?php echo e(route('register')); ?>" class="btn-secondary">Sign Up</a>
        </div>
    </div>
</div>
<?php endif; ?>
...
window.availableFrames = <?php echo json_encode($framesJson ?? [], 15, 512) ?>;
window.framesByCount = <?php echo json_encode($framesByCount ?? collect(), 15, 512) ?>;
window.hasFramesInDB = <?php echo e(isset($framesByCount) && $framesByCount->isNotEmpty() ? 'true' : 'false'); ?>;
...
window.framesData = {
    frame2: {
        brown: '<?php echo e(asset("storage/frames/4R_brown2.png")); ?>',
        cream: '<?php echo e(asset("storage/frames/4R_cream2.png")); ?>',
        white: '<?php echo e(asset("storage/frames/4R_white2.png")); ?>'
    },
    frame3: {
        brown: '<?php echo e(asset("storage/frames/4R_brown3.png")); ?>',
        cream: '<?php echo e(asset("storage/frames/4R_cream3.png")); ?>',
        white: '<?php echo e(asset("storage/frames/4R_white3.png")); ?>'
    },
    frame4: {
        brown: '<?php echo e(asset("storage/frames/4R_brown4.png")); ?>',
        cream: '<?php echo e(asset("storage/frames/4R_cream4.png")); ?>',
        white: '<?php echo e(asset("storage/frames/4R_white4.png")); ?>'
    }
};
...
<script src="<?php echo e(asset('js/photobooth-complete.js')); ?>"></script>
<?php $__env->stopPush(); ?>

<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\xampp\htdocs\bingkis-kaca\resources\views/photobooth.blade.php ENDPATH**/ ?>